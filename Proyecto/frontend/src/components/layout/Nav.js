...
const Navi = (props) => {
    return (
        <div className='divmargin'>
            <Navbar variant="dark" >
                <Container className="justify-content-end navli">   
                    <Nav variant="tabs">
                        <Nav.Item>
                            <Nav.Link href="/" className='nav-link start-link'>
                        ...
                        <Nav.Item>
                            <Nav.Link href="/cursadas" className='nav-link'>
                        ...
                        <Nav.Item>
                            <Nav.Link href="/contacto" className="nav-link end-link">
